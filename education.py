# To get the data we want, we need to extract the right table and get just the data in between the tags. 
# In this case, we're going to use a package called BeautifulSoup and our old friend, Requests
...
# pass the result to BeautifulSoup to do its thing:
